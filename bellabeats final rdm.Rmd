...
The bar chart show a slightly higher activity and less sedentary behaviour on the weekend but not a big difference between weekend and weekdays.
...
Heartrate$FormattedTime <- lubridate::dmy_hms(Heartrate$FormattedTime)
...
Weight$FormattedTime <- lubridate::dmy_hms(Weight$FormattedTime)
...
Would framing Bellabeat as a lifestyle partner—rather than a step counter—better align with the needs and expectations of its coreaudience?
